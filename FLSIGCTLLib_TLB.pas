...
// $Rev: 98336 $
// File generated on 17/10/2025 15:58:12 from Type Library described below.
...
// Parent TypeLibrary:
// (0) v1.0 FlSigCaptLib, (C:\Program Files (x86)\Common Files\WacomGSS\FlSigCapt.dll)
// SYS_KIND: SYS_WIN32
// Errors:
...
const
  ...
  IID_ISigObj4: TGUID = '{20000093-228C-4784-B8BF-97B3A840E1D0}';
  CLASS_SigObj: TGUID = '{8615302D-31CD-4E9C-83A4-14F59FDA2D59}';
  IID_IHash: TGUID = '{E490AFE3-E089-498F-8DDF-F9D9A4C7C595}';
  IID_IAdditionalImportIsoData: TGUID = '{20000362-5F9B-4A0B-B791-9292FA2CC1C1}';
  IID_IImportIsoRetVal: TGUID = '{20000342-B7E6-4518-95DD-A115A097B4EB}';
  ...
  IID__ISigCtlSigCaptX: TGUID = '{5125D999-068B-49EA-8730-9555A6F6BAA8}';
  ...
  IID_IHash2: TGUID = '{7618794A-AF0A-45DF-B322-06801D7B4B74}';
  ...
  IID__IAdditionalImportIsoData1: TGUID = '{200036B8-839C-415F-A0EA-305CBA202C79}';
  CLASS_AdditionalImportIsoData: TGUID = '{2000001C-9E00-42C7-9359-0588C46A9054}';
...
const
  ...
  // Constants for enum ImportIsoFlags
type
  ImportIsoFlags = TOleEnum;

const
  ImportIsoFlag_iso19784_7_binary = $00000001;
  ImportIsoFlag_iso19785_3_xml = $00000002;
  ImportIsoFlag_iso19784_7_encrypted_binary = $00000003;
  ImportIsoFlag_iso19784_7_encrypted_text = $00000004;

  // Constants for enum ExportIsoFlags
type
  ExportIsoFlags = TOleEnum;

const
  ExportIsoFlag_iso19784_7_binary = $00000001;
  ExportIsoFlag_iso19785_3_xml = $00000002;
  ExportIsoFlag_iso19784_7_encrypted_binary = $00000003;
  ExportIsoFlag_iso19784_7_encrypted_text = $00000004;
...
const
  ...
  ReadEncodedBitmapEncrypted = $00000004;
  ReadEncodedBitmapDecryptFailed = $00000005;
...
type
  ...
  ISigObj4 = interface;
  ISigObj4Disp = dispinterface;
  IHash = interface;
  IHashDisp = dispinterface;
  IAdditionalImportIsoData = interface;
  IAdditionalImportIsoDataDisp = dispinterface;
  IImportIsoRetVal = interface;
  IImportIsoRetValDisp = dispinterface;
  ISigCtl = interface;
  ...
  _ISigCtlSigCaptX = interface;
  _ISigCtlFirefoxCallback = interface;
  IHash2 = interface;
  IHash2Disp = dispinterface;
  IKey = interface;
  ...
  _IAdditionalImportIsoData1 = interface;
  ...
  AdditionalImportIsoData = IAdditionalImportIsoData;
  ...
  ISigObj = interface(IDispatch)
    ...
    procedure Render(hDCTarg: Integer; hDCRef: Integer; x: Integer; y: Integer; InkWidth: Single; InkColor: OLE_COLOR; Line: WordBool; Zoom: Smallint; Rotation: Smallint); safecall;
    procedure RenderRect(hDCTarg: Integer; hDCRef: Integer; Left: Integer; Top: Integer; Right: Integer; Bottom: Integer; InkWidth: Single; InkColor: OLE_COLOR; Option: DisplayMode; Zoom: Smallint; Rotation: Smallint); safecall;
  ...
  ISigObjDisp = dispinterface
    ...
    procedure Render(hDCTarg: Integer; hDCRef: Integer; x: Integer; y: Integer; InkWidth: Single; InkColor: OLE_COLOR; Line: WordBool; Zoom: Smallint; Rotation: Smallint); dispid 23;
    procedure RenderRect(hDCTarg: Integer; hDCRef: Integer; Left: Integer; Top: Integer; Right: Integer; Bottom: Integer; InkWidth: Single; InkColor: OLE_COLOR; Option: DisplayMode; Zoom: Smallint; Rotation: Smallint); dispid 24;
  end;
  ...
  ISigObj3 = interface(ISigObj2)
    ...
    function RenderBitmap(const OutputFilename: WideString; DimensionX: Integer; DimensionY: Integer; const MimeType: WideString; InkWidth: Single; InkColor: OLE_COLOR; BackgroundColor: OLE_COLOR; PaddingX: Single; PaddingY: Single; Flags: RBFlags): OleVariant; safecall;
    function Picture(DimensionX: Integer; DimensionY: Integer; const MimeType: WideString; InkWidth: Single; InkColor: OLE_COLOR; BackgroundColor: OLE_COLOR; PaddingX: Single; PaddingY: Single; Flags: RBFlags): IPictureDisp; safecall;
  ...
  ISigObj3Disp = dispinterface
    ['{4FCEFD0C-1054-47F0-AF82-4BD571D50A88}']
    function RenderBitmap(const OutputFilename: WideString; DimensionX: Integer; DimensionY: Integer; const MimeType: WideString; InkWidth: Single; InkColor: OLE_COLOR; BackgroundColor: OLE_COLOR; PaddingX: Single; PaddingY: Single; Flags: RBFlags): OleVariant; dispid 27;
    function Picture(DimensionX: Integer; DimensionY: Integer; const MimeType: WideString; InkWidth: Single; InkColor: OLE_COLOR; BackgroundColor: OLE_COLOR; PaddingX: Single; PaddingY: Single; Flags: RBFlags): IPictureDisp; dispid 28;
  ...
  // Interface: ISigObj4
  // Flags:     (4416) Dual OleAutomation Dispatchable
  // GUID:      {20000093-228C-4784-B8BF-97B3A840E1D0}
  // *********************************************************************//
  ISigObj4 = interface(ISigObj3)
    ['{20000093-228C-4784-B8BF-97B3A840E1D0}']
    function ImportIso(iso: OleVariant; ImportIsoFlags: LongWord; const pAdditionalImportIsoData: IAdditionalImportIsoData): IImportIsoRetVal; safecall;
    function ExportIso(ExportIsoFlags: LongWord): OleVariant; safecall;
  end;

  // *********************************************************************//
  // DispIntf:  ISigObj4Disp
  // Flags:     (4416) Dual OleAutomation Dispatchable
  // GUID:      {20000093-228C-4784-B8BF-97B3A840E1D0}
  // *********************************************************************//
  ISigObj4Disp = dispinterface
    ['{20000093-228C-4784-B8BF-97B3A840E1D0}']
    function ImportIso(iso: OleVariant; ImportIsoFlags: LongWord; const pAdditionalImportIsoData: IAdditionalImportIsoData): IImportIsoRetVal; dispid 30;
    function ExportIso(ExportIsoFlags: LongWord): OleVariant; dispid 31;
    function RenderBitmap(const OutputFilename: WideString; DimensionX: Integer; DimensionY: Integer; const MimeType: WideString; InkWidth: Single; InkColor: OLE_COLOR; BackgroundColor: OLE_COLOR; PaddingX: Single; PaddingY: Single; Flags: RBFlags): OleVariant; dispid 27;
    function Picture(DimensionX: Integer; DimensionY: Integer; const MimeType: WideString; InkWidth: Single; InkColor: OLE_COLOR; BackgroundColor: OLE_COLOR; PaddingX: Single; PaddingY: Single; Flags: RBFlags): IPictureDisp; dispid 28;
    function ReadEncodedBitmap(Bitmap: OleVariant): ReadEncodedBitmapResult; dispid 29;
    property CrossedOut: WordBool readonly dispid 13;
  ...
  // *********************************************************************//
  // Interface: IAdditionalImportIsoData
  // Flags:     (4416) Dual OleAutomation Dispatchable
  // GUID:      {20000362-5F9B-4A0B-B791-9292FA2CC1C1}
  // *********************************************************************//
  IAdditionalImportIsoData = interface(IDispatch)
    ['{20000362-5F9B-4A0B-B791-9292FA2CC1C1}']
    procedure Set_Who(const pRetVal: WideString); safecall;
    function Get_Who: WideString; safecall;
    procedure Set_Why(const pRetVal: WideString); safecall;
    function Get_Why: WideString; safecall;
    procedure Set_When(pRetVal: OleVariant); safecall;
    function Get_When: OleVariant; safecall;
    procedure Set_TimeZoneOffset(pRetVal: Integer); safecall;
    function Get_TimeZoneOffset: Integer; safecall;
    procedure Set_ExtraData(const Key: WideString; const pRetVal: WideString); safecall;
    function Get_ExtraData(const Key: WideString): WideString; safecall;
    property Who: WideString read Get_Who write Set_Who;
    property Why: WideString read Get_Why write Set_Why;
    property When: OleVariant read Get_When write Set_When;
    property TimeZoneOffset: Integer read Get_TimeZoneOffset write Set_TimeZoneOffset;
    property ExtraData[const Key: WideString]: WideString read Get_ExtraData write Set_ExtraData;
  end;

  // *********************************************************************//
  // DispIntf:  IAdditionalImportIsoDataDisp
  // Flags:     (4416) Dual OleAutomation Dispatchable
  // GUID:      {20000362-5F9B-4A0B-B791-9292FA2CC1C1}
  // *********************************************************************//
  IAdditionalImportIsoDataDisp = dispinterface
    ...
    property Why: WideString dispid 2;
    property When: OleVariant dispid 3;
    property TimeZoneOffset: Integer dispid 4;
    property ExtraData[const Key: WideString]: WideString dispid 5;
  end;

  // *********************************************************************//
  // Interface: IImportIsoRetVal
  // Flags:     (4416) Dual OleAutomation Dispatchable
  // GUID:      {20000342-B7E6-4518-95DD-A115A097B4EB}
  // *********************************************************************//
  IImportIsoRetVal = interface(IDispatch)
    ['{20000342-B7E6-4518-95DD-A115A097B4EB}']
    function Get_Succeeded: WordBool; safecall;
    function Get_DiagnosticMessage: WideString; safecall;
    function Get_DiagnosticCode: Integer; safecall;
    property Succeeded: WordBool read Get_Succeeded;
    property DiagnosticMessage: WideString read Get_DiagnosticMessage;
    property DiagnosticCode: Integer read Get_DiagnosticCode;
  end;

  // *********************************************************************//
  // DispIntf:  IImportIsoRetValDisp
  // Flags:     (4416) Dual OleAutomation Dispatchable
  // GUID:      {20000342-B7E6-4518-95DD-A115A097B4EB}
  // *********************************************************************//
  IImportIsoRetValDisp = dispinterface
    ['{20000342-B7E6-4518-95DD-A115A097B4EB}']
    property Succeeded: WordBool readonly dispid 1;
    property DiagnosticMessage: WideString readonly dispid 2;
    property DiagnosticCode: Integer readonly dispid 3;
  end;
  ...
  // *********************************************************************//
  _ISigCtlSigCaptX = interface(IUnknown)
    ['{5125D999-068B-49EA-8730-9555A6F6BAA8}']
    function SigCaptXAboutBox(Left: SYSINT; Top: SYSINT; Right: SYSINT; Bottom: SYSINT): HResult; stdcall;
  end;
  ...
  // Interface: IHash2
  // Flags:     (4416) Dual OleAutomation Dispatchable
  // GUID:      {7618794A-AF0A-45DF-B322-06801D7B4B74}
  // *********************************************************************//
  IHash2 = interface(IHash)
    ['{7618794A-AF0A-45DF-B322-06801D7B4B74}']
    procedure SetHash(newVal: HashType; Data: OleVariant); safecall;
  end;
  ...
  IHash2Disp = dispinterface
    ['{7618794A-AF0A-45DF-B322-06801D7B4B74}']
    procedure SetHash(newVal: HashType; Data: OleVariant); dispid 21;
    property type_: HashType dispid 1;
    property Hash: WideString readonly dispid 2;
    procedure Add(Data: OleVariant); dispid 10;
    procedure Clear; dispid 11;
  ...
  // *********************************************************************//
  // Interface: _IAdditionalImportIsoData1
  // Flags:     (256) OleAutomation
  // GUID:      {200036B8-839C-415F-A0EA-305CBA202C79}
  // *********************************************************************//
  _IAdditionalImportIsoData1 = interface(IUnknown)
    ['{200036B8-839C-415F-A0EA-305CBA202C79}']
    function GetExtraData(out Data: PSafeArray): HResult; stdcall;
  end;

  // *********************************************************************//
  // The Class CoSigObj provides a Create and CreateRemote method to
  // create instances of the default interface ISigObj4 exposed by
  // the CoClass SigObj. The functions are intended to be used by
  // clients wishing to automate the CoClass objects exposed by the
  // server of this typelibrary.
  // *********************************************************************//
  CoSigObj = class
    class function Create: ISigObj4;
    class function CreateRemote(const MachineName: string): ISigObj4;
  end;
  ...
  // create instances of the default interface IHash2 exposed by
  // the CoClass Hash. The functions are intended to be used by
  // clients wishing to automate the CoClass objects exposed by the
  // server of this typelibrary.
  // *********************************************************************//
  CoHash = class
    class function Create: IHash2;
    class function CreateRemote(const MachineName: string): IHash2;
  end;
  ...
  // *********************************************************************//
  // The Class CoAdditionalImportIsoData provides a Create and CreateRemote method to
  // create instances of the default interface IAdditionalImportIsoData exposed by
  // the CoClass AdditionalImportIsoData. The functions are intended to be used by
  // clients wishing to automate the CoClass objects exposed by the
  // server of this typelibrary.
  // *********************************************************************//
  CoAdditionalImportIsoData = class
    class function Create: IAdditionalImportIsoData;
    class function CreateRemote(const MachineName: string): IAdditionalImportIsoData;
  end;
  ...
  // *********************************************************************//
  TSigCtlPreCapture = procedure(ASender: TObject; const Who: WideString; const Why: WideString; var Continue: WordBool) of object;
  ...
  // TypeFlags        : (2) CanCreate
  // *********************************************************************//
  TSigCtlXHTMLPreCapture = procedure(ASender: TObject; const Who: WideString; const Why: WideString; var Continue: WordBool) of object;
...
class function CoSigObj.Create: ISigObj4;
begin
  result := CreateComObject(CLASS_SigObj) as ISigObj4;
end;

class function CoSigObj.CreateRemote(const MachineName: string): ISigObj4;
begin
  result := CreateRemoteComObject(MachineName, CLASS_SigObj) as ISigObj4;
end;
...
class function CoHash.Create: IHash2;
begin
  result := CreateComObject(CLASS_Hash) as IHash2;
end;

class function CoHash.CreateRemote(const MachineName: string): IHash2;
begin
  result := CreateRemoteComObject(MachineName, CLASS_Hash) as IHash2;
end;
...
class function CoAdditionalImportIsoData.Create: IAdditionalImportIsoData;
begin
  result := CreateComObject(CLASS_AdditionalImportIsoData) as IAdditionalImportIsoData;
end;

class function CoAdditionalImportIsoData.CreateRemote(const MachineName: string): IAdditionalImportIsoData;
begin
  result := CreateRemoteComObject(MachineName, CLASS_AdditionalImportIsoData) as IAdditionalImportIsoData;
end;
...
const
  ...
  CControlData: TControlData2 = (ClassID: '{963B1D81-38B8-492E-ACBE-74801D009E9E}'; EventIID: '{7423A831-443B-4774-8214-C1B9331858E0}'; EventCount: 3; EventDispIDs: @CEventDispIDs; LicenseKey: nil (* HR:$80004002 *); Flags: $0000001F; Version: 500; FontCount: 1; FontIDs: @CTFontIDs);
begin
...
function TSigCtl.Capture(const Who: WideString; const Why: WideString; What: OleVariant; Key: OleVariant): CaptureResult;
begin
...
const
  CEventDispIDs: array [0 .. 2] of DWORD = ($00000001, $00000002, $00000003);
  CTFontIDs: array [0 .. 0] of DWORD = ($FFFFFE00);
  CControlData: TControlData2 = (ClassID: '{F5DC9DFE-FD38-4455-A783-4B3F31B2D229}'; EventIID: '{7423A831-443B-4774-8214-C1B9331858E0}'; EventCount: 3; EventDispIDs: @CEventDispIDs; LicenseKey: nil (* HR:$80004002 *); Flags: $0000001F; Version: 500; FontCount: 1; FontIDs: @CTFontIDs);
begin
  ControlData := @CControlData;
  TControlData2(CControlData).FirstEventOfs := UIntPtr(@@FOnPreCapture) - UIntPtr(Self);
end;
...
function TSigCtlXHTML.Capture(const Who: WideString; const Why: WideString; What: OleVariant; Key: OleVariant): CaptureResult;
begin
  result := DefaultInterface.Capture(Who, Why, What, Key);
end;
...
const
  CControlData: TControlData2 = (ClassID: '{EFFD1818-3060-49A3-9C22-A06F57BBC167}'; EventIID: ''; EventCount: 0; EventDispIDs: nil; LicenseKey: nil (* HR:$80004002 *); Flags: $00000000; Version: 500);
begin
  ControlData := @CControlData;
end;
